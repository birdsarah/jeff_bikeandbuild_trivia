...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trivia.unit'
        db.add_column(u'trivia_trivia', 'unit',
                      self.gf('django.db.models.fields.CharField')(default='inches', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Trivia.unit'
        db.delete_column(u'trivia_trivia', 'unit')
